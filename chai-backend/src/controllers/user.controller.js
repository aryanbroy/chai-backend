...
const registerUser = asyncHandler(async (req, res) => {
    ...
    if (req.files.avatar?.length === 0 || req.files.length === undefined) {
...
const loginUser = asyncHandler(async (req, res, next) => {
    ...
    if (!user) {
        throw new ApiError(404, "User does not exist", ["User does not exist"], "User does not exist")
        // return res.status(404).json(new ApiError(404, "User does not exist", ["User does not exist"], "User does not exist"))
    }
